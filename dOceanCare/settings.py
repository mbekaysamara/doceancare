...
# Django settings for dOceanCare project.
...
from dOceanCare.views import patients, doctors, appointments, billing
...
WSGI_APPLICATION = 'dOceanCare.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'oceancare_db',  # Your database name
        'USER': 'root',  # Your MySQL username
        'PASSWORD': 'ez4u2c@1890',  # Your MySQL password
